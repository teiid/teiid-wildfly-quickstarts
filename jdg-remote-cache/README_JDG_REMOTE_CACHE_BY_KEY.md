...
-  JDG 6.2/6.3 server kit
-  JDG 6.2/6.3 Hot Rod modules for EAP kit (to be deployed into Teiid server instance)
...
-  Need to install the JBoss Data Grid 6.3.x version of the Hot Rod client library modules kit for EAP into your EAP instance.
