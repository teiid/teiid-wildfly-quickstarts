...
| [rules](drools-integration/tree/master/README.md "rules") | Integrating Drools Rules | Shows how Drools businss rules can be integrated on data moving thru Teiid | None |
