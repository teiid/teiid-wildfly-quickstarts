CREATE TABLE tpch.region(r_regionkey integer,
r_name VARCHAR(25),
r_comment VARCHAR(152),
CONSTRAINT pk_r_regionkey PRIMARY KEY ( r_regionkey));
CREATE TABLE tpch.nation(n_nationkey integer,
n_name VARCHAR(25),
n_regionkey integer,
...
CREATE TABLE tpch.customer(c_customerkey integer,
c_name VARCHAR(25),
...
CREATE TABLE tpch.supplier(s_supplierkey integer,
s_name VARCHAR(25),
...
CREATE TABLE tpch.part(p_partkey integer,
p_name VARCHAR(55),
p_mfgr VARCHAR(15),
p_brand VARCHAR(10),
p_type VARCHAR(25),
...
CREATE TABLE tpch.orders(o_orderskey integer,
...
CREATE TABLE tpch.lineitem(l_orderskey integer,
l_partkey integer,
