...
3.  Install a Teiid instance.  You can simple unzip the full runtime distribution with {{ book.asName }} from the [downloads](http://teiid.io/teiid_runtimes/teiid_wildfly/downloads/)
