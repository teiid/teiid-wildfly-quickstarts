...
See the portfolio-dataroles-vdb.xml for extra xml elements defined for define the above roles. For more information check out http://teiid.github.io/teiid-documents/master/content/reference/Data_Roles.html[Reference Guide's Data Roleschapter].
